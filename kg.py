...
while loop == 'true':
    ...
    if username == CorrectUsername:
        print '\x1b[1;92m Logged in successfully as ' + username
        time.sleep(1)
        os.system('clear')
        loop = 'false'
    else:
        print '\x1b[1;93m Wrong Key !'
...
def animate():
    for c in itertools.cycle(['\x1b[1;91m||', '\x1b[1;92m/', '\x1b[1;93m\xe2\x94\x80', '\x1b[1;96m|', '\x1b[1;95m\\']):
        if done:
            break
        sys.stdout.write('\r\x1b[1;93m______SARFRAZ\x1b[1;94m:) ' + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c)
        sys.stdout.flush()
        time.sleep(0.1)
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/.dx4.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/Sarfraz-Baloch/FILESARFRAZ/main/server.txt').text
    if to in r:
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.dx4.txt', 'r').read()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;93m     Sarfraz Baloch On Fire..   '
    print 47 * '-'
